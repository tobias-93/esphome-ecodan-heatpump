...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional("date_time"): text_sensor.text_sensor_schema(text_sensor.TextSensor,entity_category=ENTITY_CATEGORY_DIAGNOSTIC),
        ...
        cv.Optional("dhw_running_mode"): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    }
