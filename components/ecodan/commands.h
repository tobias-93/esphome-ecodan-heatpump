...
DEFINE_COMMAND(zone2_room_temp_setpoint, 15, CommandVarType_TEMPERATURE, SINGLE_ARG({0xfc, 0x41, 0x02, 0x7a, 0x10, 0x32, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}));
